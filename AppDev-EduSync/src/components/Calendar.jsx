                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1, mr: 2 }}>
                        ...
                        <Chip
                          ...
                          size="small"
                          sx={{ ml: 2, mr: 3 }} // Increased margin-right for spacing
                        />
                      </Box>
                      <Box
                        sx={{
                      ...
                      >
                        <Tooltip title={task.completed ? 'Mark as Pending' : 'Mark as Completed'}>
                          <IconButton onClick={() => handleToggleComplete(task.id)} sx={{ mx: 0.5 }}>
                            <CheckCircleIcon fontSize="medium" color={task.completed ? 'success' : 'disabled'} />
                          </IconButton>
                        </Tooltip>
                        <Tooltip title="Edit Task">
                          <IconButton onClick={() => handleEditTask(task)} sx={{ mx: 0.5 }}>
                            <EditIcon fontSize="medium" color="primary" />
                          </IconButton>
                        </Tooltip>
                        <Tooltip title="Delete Task">
                          <IconButton onClick={() => handleDeleteTask(task.id)} sx={{ mx: 0.5 }}>
